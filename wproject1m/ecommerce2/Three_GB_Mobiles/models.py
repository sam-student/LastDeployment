...
def upload_image_path(instance,filename):
    ...
    return "Three_GB_Mobiles/{new_filename}/{final_filename}".format(new_filename=filename, final_filename=final_filename)
...
class Three_GB_Mobile(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return  reverse("Three_GB_Mobiles:detail", kwargs={"slug": self.slug})
...
pre_save.connect(product_pre_save_receiver, sender=Three_GB_Mobile)