...
def upload_image_path(instance,filename):
    ...
    return "EightMPMobile/{new_filename}/{final_filename}".format(new_filename=filename, final_filename=final_filename)
...
class EightMP_Mobile(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return  reverse("EightMPMobile:detail", kwargs={"slug": self.slug})
...
pre_save.connect(product_pre_save_receiver, sender=EightMP_Mobile)