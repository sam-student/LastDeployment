...
def upload_image_path(instance,filename):
    ...
    return "FiveMPMobile/{new_filename}/{final_filename}".format(new_filename=filename, final_filename=final_filename)
...
class FiveMP_Mobile(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return  reverse("FiveMPMobile:detail", kwargs={"slug": self.slug})
...
pre_save.connect(product_pre_save_receiver, sender=FiveMP_Mobile)