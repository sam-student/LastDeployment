...
def upload_image_path(instance,filename):
    ...
    return "TwelveMPMobile/{new_filename}/{final_filename}".format(new_filename=filename, final_filename=final_filename)
...
class TwelveMP_Mobile(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return  reverse("TwelveMPMobile:detail", kwargs={"slug": self.slug})
...
pre_save.connect(product_pre_save_receiver, sender=TwelveMP_Mobile)