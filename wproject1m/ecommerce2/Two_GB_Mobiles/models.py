...
def upload_image_path(instance,filename):
    ...
    return "Two_GB_Mobiles/{new_filename}/{final_filename}".format(new_filename=filename, final_filename=final_filename)
...
class Two_GB_Mobile(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return  reverse("Two_GB_Mobiles:detail", kwargs={"slug": self.slug})
...
pre_save.connect(product_pre_save_receiver, sender=Two_GB_Mobile)