...
def upload_image_path(instance,filename):
    ...
    return "FivektoTenk/{new_filename}/{final_filename}".format(new_filename=filename, final_filename=final_filename)
...
class FivektoTenk_Mobile(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return  reverse("FivektoTenk:detail", kwargs={"slug": self.slug})
...
pre_save.connect(product_pre_save_receiver, sender=FivektoTenk_Mobile)